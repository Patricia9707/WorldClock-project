function updateCity(event) {
  ...
  // Dynamically create the city block with the time and date for the selected city
...
function updateTime() {
  ...
  parisElement.querySelector(".time").innerHTML = parisTime.format("h:mm:ss [<small>]A[</small>]");
}
